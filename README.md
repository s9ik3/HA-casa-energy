...
- **Tariffe congelate sui mesi chiusi**: quando modifichi prezzo, costi fissi, oneri o IVA dalle Opzioni, la nuova tariffa si applica dal 1° del mese corrente in poi; i mesi già chiusi restano fissi alla tariffa con cui erano stati calcolati e non cambiano più, anche a fronte di modifiche future. Per resettare questo comportamento e far ricalcolare tutti i mesi passati con la tariffa attuale, spunta "Reset tariffe congelate" nello step Tariffa delle Opzioni.
